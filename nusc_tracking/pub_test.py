...
def parse_args():
    ...
    parser.add_argument(
        "--checkpoint",help="the dir to checkpoint which the model read from", default='test/rcdetr_90e_640×1600_trainval/Thu_Aug__8_21_25_06_2024/pts_bbox/results_nusc.json'
    )
