...
class StreamRCDETRHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is StreamRCDETRHead):
        ...
        super(StreamRCDETRHead, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is StreamRCDETRHead:
            convert_dict = {
    ...
    def forward(self, memory_center, img_metas, topk_indexes=None,  **data):
        ...
        bev_memory = rearrange(memory_radar, "bs c h w -> (h w) bs c") # [bs, n, c, h, w] -> [n*h*w, bs, c]
