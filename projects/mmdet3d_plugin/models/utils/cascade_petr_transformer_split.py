...
class CascadePETRTransformerDecoderSplit(TransformerLayerSequence):
    ...
    def __init__(self,
        ...
        super(CascadePETRTransformerDecoderSplit, self).__init__(*args, **kwargs)
...
class CascadePETRTemporalTransformerSplit(BaseModule):
    ...
    def __init__(self, encoder=None, decoder=None, init_cfg=None, cross=False):
        super(CascadePETRTemporalTransformerSplit, self).__init__(init_cfg=init_cfg)
